...
function AddVisitorLogs() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:8085/visitorLogs/addVisitorLog/${residentId}/${gatekeeperId}`,
        visitorLogData
      );
          ...
          <div className="card ">
            <div className="card-body p-2">
              ...
              <label htmlFor="residentId" className="form-label">Resident :</label>
                    ...
                    <p>Selected Resident ID: {residentId}</p>
  </div>
  ...
  <div className="row mb-3">
    <div className="col-md-6">
      <label htmlFor="entryttime" className="form-label">Entry Time</label>
      <input
        type="datetime-local"
